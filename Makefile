...
Card_public_test.exe: Card.cpp Card_public_test.cpp
	$(CXX) $(CXXFLAGS = --std=c++11 -Wall -Werror -pedantic -g -fsanitize=address -fsanitize=undefined) $^ -o $@
...
Pack_tests.exe: Card.cpp Pack.cpp Pack_tests.cpp
	$(CXX) $(CXXFLAGS = clang++ --std=c++11 -Wall -Werror -pedantic -g -fsanitize=address -fsanitize=undefined) $^ -o $@
